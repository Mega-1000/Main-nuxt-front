...
<div class="padding_20">
   <div class="proc_100 animatable fadeInUp animated">
      <div class="max_szer">
         ...
         <p>&nbsp;</p>
         <p>&nbsp;</p>
         <p><span style="font-size:20px;"><strong>ODBIOR Z POBLISKICH MAGAZYNOW CZY WYSYLKA Z NAJTANSZYCH MAGAZYNOW ??</strong></span></p>
         <p>W przypadku drobnych ilosci badz potrzeby pilnego otrzymaniu towaru w tym samym dniu nalezy w polu uwaga wpisac pilne na dzis aczkolwiek ceny z magazynow loklanych beda wyzsze niz podane w systemie.</p>
         <p>Natomiast w przypadku mozliwosci otrzymania towaru w dniach nastepnych (soboty i niedziele pominac firmy kurierskie nie pracuja) bedziemy miec mozliwosc podania cen z najtanszego magazynu w Polsce i pomimo dodania kosztow przesylki najczesciej sa duzo atrakcyjniesze niz dostawa z magazynow lokalnych.</p>
         <p>&nbsp;</p>
         <p><span style="font-size:16px;"><strong>WYCENA TOWAROW</strong></span></p>
         <p>Aby wykonac wycene towaru nalezy wejsc do odpowiedniego dzialu (menu po lewej stronie)</p>
         <p>Nastepnie po wybraniu dzialu pojawia sie produktu przy ktorych po prawej stronie bedzie przycisk <span style="background-color:#FFFFFF;">WYCENA TOWARU</span></p>
         <p>Po jego wrzuceniu do koszyka mozemy kontynuowac zakupy z dowolnych dzialow w menu po lewej stronie.</p>
         <p>Gdy wrzucimy ostatni produkt do koszyka nalezy przejsc na prawy gorny rog strony i wcisnac obrazek koszyka po czym pojawi sie lista wszystkich wybranych produktow.</p>
         <p>Natepnie mozemy jeszcze skorygowac na tej liscie zapytanie po czym na dole tej listy uzyc przyciksku WYSLIJ DO AKCEPTACJI GRATISOWEGO TRANSPORTU</p>
         <p>Po wyslaniu tego niezobowiazujacego do niczego zapytania dostaniecie od nas w przeciagu kilku minut kompletna wycene oraz informacje na temat warunkow dostawy.</p>
         <p>!!! OGOLNE KOSZTY TRANSPORTU DLA WSZYSYTKICH DZIALOW !!!<br>
            &nbsp;&nbsp; Paczki do 30 kg i gabarytach ok 100x50x50cm oraz 200x25x25 -- ok 13 zl<br>
            &nbsp;&nbsp; Dluzyca 250x20x20 -- ok 35 zl<br>
            &nbsp;&nbsp; Paleta do 1000 kg -- ok 150 zl<br>
            &nbsp;&nbsp; Zachecamy zawsze do zakupu roznych materialow z danego i takze innych dzialow poniewaz koszt przesylki zbiorowej to ok 150 zl za palete nie zaleznie od ilosci i asortymentu wydawanego z danego magazynu
         </p>
         <p>&nbsp;</p>
         <p>&nbsp;</p>
         <p>&nbsp;</p>
         <p><span style="font-size:22px;">Towary wysylane sa z magazynow w calej Polsce (ponad 1000)&nbsp;aczkolwiek podane ceny moga nie obowiazywac we wszystkich.</span></p>
         <p>&nbsp;</p>
         <p></p>
         <h1>Współpracujemy z <b>3095</b> firmami</h1>
         <p></p>
      </div>
   </div>
</div>

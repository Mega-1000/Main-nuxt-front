          ...
          <form class="space-y-6" @submit.prevent="createChat">
            ...
            <div v-if="isOrderStyrofoam" class="mt-4">
              ...
              <div>
                ...
                <input type="date" id="delivery-start-date" v-model="deliveryStartDate" class="block w-full px-3 py-2 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
              </div>

              <div class="mt-4">
                <label for="delivery-end-date" class="block mb-2 text-sm font-medium text-gray-900">do</label>
                <input type="date" id="delivery-end-date" v-model="deliveryEndDate" class="block w-full px-3 py-2 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
              </div>

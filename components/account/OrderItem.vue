...
<template>
  <div class="relative space-y-3 rounded-xl shadow-lg p-3 w-[60vw] max-w-7xl mx-auto border border-white bg-white">
    ...
    <div class="mt-4" style="margin: 40px 0" v-if="item.auctionCanBeCreated">
      ...
      <br>
      <br>
      <a :href="`https://admin.mega1000.pl/auctions/${item.chat.id}/create`" target="_blank" style="margin-top: 20px" class="px-5 my-6 py-3 rounded text-white bg-green-500">
        Rozpocznij przetarg
      </a>
    </div>

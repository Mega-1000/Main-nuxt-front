...
<template>
  <div>
    ...
    <a v-if="type === 'link'" :href="href"
      class="p-1 bg-slate-100 text-xs text-gray-900 border rounded hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 border-gray-700" :target="target">
      <slot />
    </a>
  </div>
</template>

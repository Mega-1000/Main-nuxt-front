    ...
    <div v-if="tutorialActive" class="tutorial-overlay">
      <div class="tutorial-modal">
        <div class="tutorial-content">
          ...
          <button v-if="tutorialStep === 0" @click="tutorialActive = false; localStorage.setItem('navbarTutorialEnded', true)" class="text-white bg-red-700 hover:bg-red-800 mt-2 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:bg-gray-500">

...
<template>
  <div class="flex flex-col justify-center">
    <div
      ...
      class="cursor-pointer relative flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 w-[60vw] max-w-7xl mx-auto border border-white bg-white"
    >
      <div

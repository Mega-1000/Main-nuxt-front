<template>
  <div id="alert-additional-content-4" class="mt-4 sm:w-full md:w-2/3 mx-auto p-4 mb-4 text-gray-800 border border-gray-300 rounded-lg bg-gray-50" role="alert">
